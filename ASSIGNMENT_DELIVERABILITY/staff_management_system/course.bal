...
|};
 ...
 // Error handler for Adding course
...
service /courseMangement/course on new http:Listener(9000) {
	...
	resource function get course() returns courseEntry[] {
...
resource function remove course(string courseCode) returns http:Response {
    courseEntry.remove(courseCode);
}
